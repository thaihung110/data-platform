...
# Script to build and push Docker image for FastAPI CSV Uploader to Docker Hub

set -eu

# Configuration
DOCKERHUB_USERNAME="${DOCKERHUB_USERNAME:-hungvt0110}"
IMAGE_NAME="${IMAGE_NAME:-fastapi-csv-uploader}"
...
echo "=========================================="
echo "Building Docker image for FastAPI CSV Uploader"
echo "=========================================="
...
if [ "${PUSH_TO_DOCKERHUB}" = "true" ]; then
    ...
    echo "  kubectl set image deployment/fastapi-csv-uploader api=${FULL_IMAGE_NAME} -n default"
    echo "  kubectl rollout restart deployment/fastapi-csv-uploader -n default"
else
    echo ""
    echo "=========================================="
